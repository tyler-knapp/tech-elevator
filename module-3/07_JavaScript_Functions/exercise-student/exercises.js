 ...
 * function and uses that in the `unfilteredArray` filter function. Return the result.w
 *
...
function useParameterToFilterArray(filterFunction){
    let allEven = unfilteredArray.filter(
        (filterFunction) => {
            return filterFunction % 2 === 0;
        }
    );
    return allEven;
}
 ...
 */
 ...
 function makeNumber(first , second =''){
    ...
    let result = parseInt(description)
    return result;
 }
