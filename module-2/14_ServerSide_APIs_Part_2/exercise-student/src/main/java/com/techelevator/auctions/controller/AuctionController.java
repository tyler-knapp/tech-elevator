...
public class AuctionController {
    ...
    public Auction update(@Valid @RequestBody Auction auction , @PathVariable Integer id) throws AuctionNotFoundException{
        return dao.update(auction, id);
    }

    @ResponseStatus(HttpStatus.NO_CONTENT)
    @RequestMapping(path = "/{id}", method = RequestMethod.DELETE)
    public void delete(@Valid @PathVariable Integer id) throws AuctionNotFoundException{
        dao.delete(id);
    }
