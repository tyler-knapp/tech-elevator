...
SELECT name, (gnp / population) * 1000000 AS percapitagnp
FROM country
WHERE continent = 'Europe';

-- 22. The number of years since independence for all countries that have a year of independence (192 rows)
SELECT (2021 - indepyear) AS yearssinceindep 
FROM country
WHERE indepyear IS NOT NULL;
--Is there a way to use like a DATE or YEAR keyword instead of hard coding the current year??
