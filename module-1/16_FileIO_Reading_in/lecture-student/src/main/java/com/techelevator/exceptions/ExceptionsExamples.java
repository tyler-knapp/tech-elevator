...
public class ExceptionsExamples {
    ...
    public static void main(String[] args) {
        ...
        try {
            x = nums[3];
            x = x + 10; //This line only runs if there is no exception on the line about it
        } catch (ArrayIndexOutOfBoundsException e){
            //The catch block only runs if an excepton of that type occurs
        ...
        } catch (Exception e){ //Can use Polymorphism to catch exception by their superclass
