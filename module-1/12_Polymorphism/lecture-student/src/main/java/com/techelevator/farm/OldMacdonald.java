...
public class OldMacdonald {
	public static void main(String[] args) {
		...
		Singable[] farmAnimals = new Singable[] { new Cow(), new Chicken(),
				new Sheep(), new Tractor(), new Duck(), new MusicBox()};
		...
		/*
		Seen as a chicken it has: layEgg(), getPrice(), calculate Shipping()
			getSound(), getName()
		 */
