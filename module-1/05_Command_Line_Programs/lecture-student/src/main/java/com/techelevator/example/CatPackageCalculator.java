...
public class CatPackageCalculator {
        /*
            1. Take Input
            2. Calculate data
            3. Give Output
    ...
    public static void main(String[] args) {
        ...
        double avgVolumeOfHouseCats = 0.083;
        ...
        //2. Calculate how many cats wil fit in a container with those dimensions
        double containerVolume = lengthOfContainer * widthOfContainer * heightOfContainer;
        double catsByVolume = containerVolume / avgVolumeOfHouseCats;
        ...
        System.out.println("------------------------------------------------------------");
        System.out.printf("%-15s %-15s %-15s %-6.0f %n", heightOfContainer , widthOfContainer, lengthOfContainer, packedCats);
